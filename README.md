...
## Excel
<影片> [Excel教材集](https://www.youtube.com/watch?v=wg3R5LdQ56k&list=PL7enJ2-v6SPm-EHMuRMCG7R7C-vXQugNM&index=2)
#### 《快捷鍵》
###### Ctrl + 方向鍵（快速移動到表格末）
###### Shift + 方向鍵 + End（快速選取到表格末）
###### F4（(一般) 複製上一棟動作，應用在新變動格）
###### F4（(函數) 固定變動欄位）
###### Ctrl + / -（快速新增/刪除 列/欄）
###### 自動填滿（連點右十字兩下，自動補到最後）
...
###### RoundDown（無條件捨去）
###### Count（含數字的欄位個數）
###### CountIf（含單個指定條件的欄位個數）
###### CountIfs（含多指定條件的欄位個數）
